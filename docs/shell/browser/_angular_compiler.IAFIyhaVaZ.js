import { a as S, b as ue } from "@nf-internal/chunk-JKOY2XUY";
...
function oA(n) { let e = new ae; return e.set("minVersion", d(iA)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type), e.set("decorators", n.decorators), e.set("ctorParameters", n.ctorParameters), e.set("propDecorators", n.propDecorators), y(f.declareClassMetadata).callFn([e.toLiteralMap()]); }
function s_(n, e) { if (e === null || e.length === 0)
    return oA(n); let t = new ae, s = new ae; return s.set("decorators", n.decorators), s.set("ctorParameters", n.ctorParameters ?? d(null)), s.set("propDecorators", n.propDecorators ?? d(null)), t.set("minVersion", d(aA)), t.set("version", d("20.3.13")), t.set("ngImport", y(f.core)), t.set("type", n.type), t.set("resolveDeferredDeps", ud(e)), t.set("resolveMetadata", ie(e.map(r => new J(r.symbolName, He)), s.toLiteralMap())), y(f.declareClassMetadataAsync).callFn([t.toLiteralMap()]); }
...
function a_(n) { let e = new ae; return e.set("minVersion", d(wA)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), e.set("deps", lA(n.deps)), e.set("target", y(f.FactoryTarget).prop(Bt[n.target])), { expression: y(f.declareFactory).callFn([e.toLiteralMap()]), statements: [], type: wp(n) }; }
var EA = "12.0.0";
function o_(n) { let e = SA(n), t = y(f.declareInjectable).callFn([e.toLiteralMap()]), s = kp(n); return { expression: t, type: s, statements: [] }; }
function SA(n) { let e = new ae; if (e.set("minVersion", d(EA)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.providedIn !== void 0) {
...
function yA(n) { let e = new ae; return e.set("minVersion", d(xA)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), e.set("providers", n.providers), n.imports.length > 0 && e.set("imports", R(n.imports)), e; }
var CA = "14.0.0";
...
function AA(n) { let e = new ae; if (n.kind === Yt.Local)
    throw new Error("Invalid path! Local compilation mode should not get into the partial compilation path"); return e.set("minVersion", d(CA)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.bootstrap.length > 0 && e.set("bootstrap", Ct(n.bootstrap, n.containsForwardDecls)), n.declarations.length > 0 && e.set("declarations", Ct(n.declarations, n.containsForwardDecls)), n.imports.length > 0 && e.set("imports", Ct(n.imports, n.containsForwardDecls)), n.exports.length > 0 && e.set("exports", Ct(n.exports, n.containsForwardDecls)), n.schemas !== null && n.schemas.length > 0 && e.set("schemas", R(n.schemas.map(t => t.value))), n.id !== null && e.set("id", n.id), e; }
var _A = "14.0.0";
function u_(n) { let e = kA(n), t = y(f.declarePipe).callFn([e.toLiteralMap()]), s = Hp(n); return { expression: t, type: s, statements: [] }; }
function kA(n) { let e = new ae; return e.set("minVersion", d(_A)), e.set("version", d("20.3.13")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.isStandalone !== void 0 && e.set("isStandalone", d(n.isStandalone)), e.set("name", d(n.pipeName ?? n.name)), n.pure === !1 && e.set("pure", d(n.pure)), e; }
