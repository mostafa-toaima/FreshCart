import { a } from "@nf-internal/chunk-F64D2ISK";
import { a as h } from "@nf-internal/chunk-SVIUGILY";
import { c as I, m as u, n as l, o as p, p as v, q as f, r as y, s as A, t as g } from "@nf-internal/chunk-N26NRATF";
import { signal as c, QueryList as d, isSignal as o, effect as b } from "@angular/core";
import { Subscription as w, Subject as m } from "rxjs";
var _ = class {
    _items;
    _activeItemIndex = c(-1);
    _activeItem = c(null);
    _wrap = !1;
    ...
    constructor(e, i) { this._items = e, e instanceof d ? this._itemChangesSubscription = e.changes.subscribe(t => this._itemsChanged(t.toArray())) : o(e) && (this._effectRef = b(() => this._itemsChanged(e()), { injector: i })); }
    tabOut = new m;
    change = new m;
    ...
    withTypeAhead(e = 200) { this._typeaheadSubscription.unsubscribe(); let i = this._getItemsArray(); return this._typeahead = new a(i, { debounceInterval: typeof e == "number" ? e : void 0, skipPredicate: t => this._skipPredicateFn(t) }), this._typeaheadSubscription = this._typeahead.selectedItem.subscribe(t => { this.setActiveItem(t); }), this; }
    ...
    onKeydown(e) { let i = e.keyCode, s = ["altKey", "ctrlKey", "metaKey", "shiftKey"].every(r => !e[r] || this._allowedModifierKeys.indexOf(r) > -1); switch (i) {
        ...
        case 34: if (this._pageUpAndDown.enabled && s) {
            let r = this._activeItemIndex() + this._pageUpAndDown.delta, n = this._getItemsArray().length;
            this._setActiveItemByIndex(r < n ? r : n - 1, -1);
            break;
        }
        else
            return;
        default:
            (s || h(e, "shiftKey")) && this._typeahead?.handleKey(e);
            return;
    ...
    _getItemsArray() { return o(this._items) ? this._items() : this._items instanceof d ? this._items.toArray() : this._items; }
